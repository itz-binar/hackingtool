...
echo "  ╚═╝   ╚═╝   ╚══════╝╚═════╝ ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝";
echo "  [+]=====================================================[+]";
echo "  [+]   H4CK3R STYL3 - 5ECUR1TY T00L5 - CYB3R W4RF4R3    [+]";
echo "  [+]=====================================================[+]";

echo -e "${BLUE}                                    https://github.com/itz-binar/hackingtool ${NC}"
echo -e "${RED}                                     [!] This Tool Must Run As ROOT [!]${NC}\n"
echo -e "${CYAN}              Select Best Option : \n"
echo -e "${WHITE}              [1] Kali Linux / Parrot-Os / Ubuntu / Debian (apt)"
echo -e "${WHITE}              [2] Arch Linux / Manjaro (pacman)"
echo -e "${WHITE}              [3] Fedora / CentOS / RHEL (dnf/yum)"
echo -e "${WHITE}              [0] Exit "
...
if [[ $choice =~ ^[1-2]+$ ]]; then
    ...
    if curl -s -m 10 https://www.google.com > /dev/null || curl -s -m 10 https://www.github.com > /dev/null; then
        ...
        if sudo git clone https://github.com/itz-binar/hackingtool.git $install_dir; then
